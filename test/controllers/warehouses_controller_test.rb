...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { description: @warehouse.description, location: @warehouse.location, name: @warehouse.name } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { description: @warehouse.description, location: @warehouse.location, name: @warehouse.name } }
